...
mantle_depth = shell_width(mantle_mass, rho_mantle, planet_core_radius)
print("initial mantle depth", mantle_depth)
...
for i in range(10):
    ...
    print("old core radius", planet_core_radius)
    # growing in size
