...
def root_bracket(func, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux):
    """Finds the lower/upper bound of an interval that can be used for the bisection search."""
    if func == f:
        val = mol_fe
        FB = func(mol_fe, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux)
        ...
        val = 1e-6
        FA = g(0, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux)
        while val <= mol_v and FA * g(val, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux) > 0:
            val *= 1.0001
        return val


def bisection_search(func, a, b, eps, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux):
    """Aux refers to either fe_metal or v_metal, depending on which function kd(Si-Fe) or kd(V-Fe) is being searched for the root."""
    while True:
        FA = func(a, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux)
        elem_metal = (a + b) / 2
        FP = func(elem_metal, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, aux)
