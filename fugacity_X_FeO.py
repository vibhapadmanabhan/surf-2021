...
"""Generates a plot of fO2-IW w.r.t amount of FeO in the mantle. """
r_impactor = 100 * 1e3
...
for i in range(len(fe_s)):
    ...
    fe_metal = bisection_search(root_bracket(mol_fe, mol_ni, mol_si, mol_o, P_eq), mol_fe, 10e-7, mol_fe, mol_ni, mol_si, mol_o, P_eq)
