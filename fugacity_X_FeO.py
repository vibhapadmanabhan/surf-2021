...
for i in range(len(fe_s)):
    ...
    fe_metal = bisection_search(root_bracket(mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, 0), mol_fe, 10e-7, mol_fe, mol_ni, mol_si, mol_o, mol_v, mol_mg, P_eq, T_eq, 0)
